  ...
  async up (queryInterface, Sequelize) {
     ...
     */
      ...
      await queryInterface.createTable('Users', {
        ...
        id: {
          type: Sequelize.BIGINT, // BIGINT UNSIGNED là dùng trong MySQL, nhưng Sequelize không có kiểu dữ liệu UNSIGNED, nên dùng BIGINT bình thường
          allowNull: false,
          autoIncrement: true,
          primaryKey: true
        },
        ...
        role: {
          type: Sequelize.ENUM('customer', 'affiliate', 'staff', 'admin'),
          allowNull: false,
        ...
        // failed_login_account: Số lần đăng nhập sai liên tiếp, khóa tài khoản tại 5, TINYINT UNSIGNED, không được null, mặc định là 0
        ...
        updated_at: {
            type: Sequelize.DATE,
            allowNull: false,
            defaultValue: Sequelize.literal('CURRENT_TIMESTAMP') // Lưu ý: Sequelize không hỗ trợ trực tiếp 'ON UPDATE CURRENT_TIMESTAMP', nên cần xử lý trong ứng dụng hoặc trigger
        },
      ...
      await queryInterface.sequelize.query(`
        ALTER TABLE "Users"
        ADD CONSTRAINT "chk_users_points"
